...
function html(body, title) {
  body = body || '';
  title = title || (index ? 'Build list - ' : '') + 'This page shows raw metrics generated by saucelabs-browsertime for the build ' + env.BUILD_NUMBER;
